...
const SubNav = (props) =>{
    ...
    return(
        <ul className="sub-nav">
            ...
            <li><NavLink activeClassName="active" exact to="/homework/4"><img src="./img/text_homework_navi.png" alt="과제"/> <span className="numS num4">4</span></NavLink></li>
            <li><NavLink activeClassName="active" exact to="/homework/3/4"><img src="./img/text_homework_navi.png" alt="과제"/> <span className="numS numR">R</span></NavLink></li>
        </ul>
    )
}
